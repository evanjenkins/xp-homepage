...
<div class="row up-1 medium-up-3 large-up-5">
  <div class="column">
    <div class="color-block">
      <span style="background: #faf100"></span>
      #faf100
    </div>
  </div>
  <div class="column">
...
Color sections allow the use of a full-width background color to separate logical contents of the page.

```html_example
<div class="color-section color-section--charcoal-gray">
  <div class="row align-center">
    <div class="small-10 columns">
      <div class="callout">
        <h3>Charcoal gray background</h3>
        <p>Add a <code>.color-section</code> & <code>.color-section--charcoal-gray</code>
      </div>
    </div>
  </div>
</div>
```
```html_example
<div class="color-section color-section--light-gray">
  <div class="row align-center">
    <div class="small-10 columns">
      <div class="callout">
        <h3>Light gray background</h3>
        <p>Add a <code>.color-section</code> & <code>.color-section--light-gray</code>
      </div>
    </div>
  </div>
</div>
